    ...
    <nav class="navbar navbar-inverse" role="navigation">
      ...
      <div id="main-nav" class="collapse navbar-collapse">
        <ul class="nav navbar-nav" id="mainNav">
          <li class="active" id="firstLink"><a href="#song" class="scroll-link">All English songs</a></li>
...
<section id="songs">
  ...
  <!-- Heading -->
	...
	<h2 style="color:white">All English Songs</h2>
	</div>
	<br>
	<table>
			  <tr>
