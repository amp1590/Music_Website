...
<!--[if lt IE 9]> 
    ...
    <![endif]-->
<title><?php echo $_GET['b_genre_logged'];?> | Bangla</title>
    ...
    <nav class="navbar navbar-inverse" role="navigation">
      ...
      <div id="main-nav" class="collapse navbar-collapse">
        <ul class="nav navbar-nav" id="mainNav">
          <li class="active" id="firstLink"><a href="#<?php echo $_GET['b_genre_logged']; ?>" class="scroll-link"><?php echo $_GET['b_genre_logged']; ?> song</a></li>
...
<br><br><br>
<div id="<?php echo $_GET['b_genre_logged']; ?>">
<br>
    </div>
</section>
  ...
  <!-- Heading -->
    <div class="heading text-center"> 
	    <div style="background-color:#C71585">
            <h2><?php echo $_GET['b_genre_logged']; ?></h2>
