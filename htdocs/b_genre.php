...
session_start();
    ...
    if(isset($_COOKIE['username'])) 
    {
              $_SESSION['username']=$_COOKIE['username'];
                 header('Location: b_genre_logged.php');
    } 
...
<!--[if lt IE 9]> 
    ...
    <![endif]-->
<title><?php echo $_GET['b_genre'];?> | Bangla</title>
    ...
    <nav class="navbar navbar-inverse" role="navigation">
      ...
      <div id="main-nav" class="collapse navbar-collapse">
        <ul class="nav navbar-nav" id="mainNav">
          <li class="active" id="firstLink"><a href="#<?php echo $_GET['b_genre']; ?>" class="scroll-link"><?php echo $_GET['b_genre']; ?> song</a></li>
