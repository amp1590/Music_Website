    ...
    <nav class="navbar navbar-inverse" role="navigation">
      ...
      <div id="main-nav" class="collapse navbar-collapse">
        <ul class="nav navbar-nav" id="mainNav">
          ...
          <li><a href="logout.php" class="scroll-link">Log out</a></li>
		  <li><div id="me">
...
<section id="songs">
  ...
  <!-- Heading -->
	...
	<div class="dropdown" style="float:right;">
          <button class="dropbtn">Genre</button>
			<div class="dropdown-content">
               <a href="b_genre_logged.php?b_genre_logged=<?php echo"$band"; ?>">Band</a>
			   <a href="b_genre_logged.php?b_genre_logged=<?php echo"$bfolk"; ?>">Bangla Folk</a>
			   <a href="b_genre_logged.php?b_genre_logged=<?php echo"$modern"; ?>">Modern</a>
			   <a href="b_genre_logged.php?b_genre_logged=<?php echo"$nazrul"; ?>">Nazrul</a>
			   <a href="b_genre_logged.php?b_genre_logged=<?php echo"$patriotic"; ?>">Patriotic</a>
               <a href="b_genre_logged.php?b_genre_logged=<?php echo"$tagore"; ?>">Tagore</a> 
           </div>
       </div>
	...
	<table>
	  	...
	  	<?php	
			...
			<tr>
                  ...
                  <td><a href="play_logged.php?p_id=<?php echo "$id"; ?>">play</a></td>
              </tr>
			<?php } 
			...
			<br>
			<a href="all_bangla_logged.php" <button class="button" style="vertical-align:middle"><span>Show all songs</span></button></a>
	...
	<div class="dropdown" style="float:right;">
          <button class="dropbtn">Genre</button>
           <div class="dropdown-content">
		       <a href="e_genre_logged.php?e_genre_logged=<?php echo"$blues"; ?>">Blues</a>
			   <a href="e_genre_logged.php?e_genre_logged=<?php echo"$country"; ?>">Country</a>
			   <a href="e_genre_logged.php?e_genre_logged=<?php echo"$electronica"; ?>">Electronica</a>
			   <a href="e_genre_logged.php?e_genre_logged=<?php echo"$efolk"; ?>">English Folk</a>
			   <a href="e_genre_logged.php?e_genre_logged=<?php echo"$hiphop"; ?>">Hip hop</a>
               <a href="e_genre_logged.php?e_genre_logged=<?php echo"$pop"; ?>">Pop</a> 
			   <a href="e_genre_logged.php?e_genre_logged=<?php echo"$rock"; ?>">Rock</a> 
           </div>
       </div>
	...
	<table>
	  	...
	  	<?php	
			...
			<br>
			<a href="all_english_logged.php" <button class="button" style="vertical-align:middle"><span>Show all songs</span></button></a>
  ...
  <!-- Heading -->
	...
	<table>
	  	...
	  	<?php	
			...
			<br>
			<a href="all_bangla_l_logged.php" <button class="button" style="vertical-align:middle"><span>Show all songs</span></button></a>
	...
	<table>
	  	...
	  	<?php	
			...
			<br>
			<a href="all_english_l_logged.php" <button class="button" style="vertical-align:middle"><span>Show all songs</span></button></a>
    </div> 
  </div>
</section>
  ...
  <!-- Heading -->
	...
	<table>
	  	...
	  	<?php	
			...
			<br>
			<a href="all_remix_logged.php" <button class="button" style="vertical-align:middle"><span>Show all songs</span></button></a>
  ...
  <div class="container">
	...
	<div class="dropdown" style="background-color: #4CAF50; padding:3px 3px 3px 3px;float:left;">
          <button class="dropbtn">What are you feeling now !!</button>
			<div class="dropdown-content">
               <a href="ffeeling_logged.php?ffeeling_logged=<?php echo"$broken"; ?>">Broken</a>
			   <a href="ffeeling_logged.php?ffeeling_logged=<?php echo"$dancing"; ?>">Dancing</a>
			   <a href="ffeeling_logged.php?ffeeling_logged=<?php echo"$depressed"; ?>">Depressed</a>
			   <a href="ffeeling_logged.php?ffeeling_logged=<?php echo"$inspired"; ?>">Inspired</a>
			   <a href="ffeeling_logged.php?ffeeling_logged=<?php echo"$party_mood"; ?>">Party mood</a>
               <a href="ffeeling_logged.php?ffeeling_logged=<?php echo"$refreshed"; ?>">Refreshed</a> 
			   <a href="ffeeling_logged.php?ffeeling_logged=<?php echo"$romantic"; ?>">Romantic</a>
			   <a href="ffeeling_logged.php?ffeeling_logged=<?php echo"$sleepy"; ?>">Sleepy</a>
               <a href="ffeeling_logged.php?ffeeling_logged=<?php echo"$tired"; ?>">Tired</a> 
           </div>
       </div>
	...
	<div class="dropdown" style="background-color: #4CAF50; padding: 3px 3px 3px 3px;float:right;">
          <button class="dropbtn">Choose your activity/environment</button>
			<div class="dropdown-content">
               <a href="aactivity_logged.php?aactivity_logged=<?php echo"$adieu"; ?>">Adieu</a>
			   <a href="aactivity_logged.php?aactivity_logged=<?php echo"$boat_journey"; ?>">Boat journey</a>
			   <a href="aactivity_logged.php?aactivity_logged=<?php echo"$bus_journey"; ?>">Bus journey</a>
			   <a href="aactivity_logged.php?aactivity_logged=<?php echo"$party"; ?>">Party</a>
			   <a href="aactivity_logged.php?aactivity_logged=<?php echo"$rainy_day"; ?>">Rainy day</a>
               <a href="aactivity_logged.php?aactivity_logged=<?php echo"$romantic_environment"; ?>">Romantic environment</a> 
			   <a href="aactivity_logged.php?aactivity_logged=<?php echo"$victory_day"; ?>">Victory day</a>
               <a href="aactivity_logged.php?aactivity_logged=<?php echo"$leisure_time"; ?>">Leisure time</a>
           </div>
       </div>
