...
session_start();
    ...
    if(isset($_COOKIE['username'])) 
    {
              $_SESSION['username']=$_COOKIE['username'];
                 header('Location: ffeeling_logged.php');
    } 
...
<!--[if lt IE 9]> 
    ...
    <![endif]-->
<title><?php echo $_GET['ffeeling'];?></title>
...
<section>
  <div class="container" >
	...
	<div class="dropdown" style="background-color: #4CAF50; padding:3px 3px 3px 3px;float:right;">
          <button class="dropbtn">Choose your aactivity/environment</button>
			<div class="dropdown-content">
	    ...
	    <br><br><br>
		<div align="center">
		<h2>Feeling  <?php echo $_GET['ffeeling'];?></h2 >
