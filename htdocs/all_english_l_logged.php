...
<!--[if lt IE 9]> 
    ...
    <![endif]-->
<title>All english songs lyrics</title>
    ...
    <nav class="navbar navbar-inverse" role="navigation">
      ...
      <div id="main-nav" class="collapse navbar-collapse">
        <ul class="nav navbar-nav" id="mainNav">
          <li class="active" id="firstLink"><a href="#lyrics" class="scroll-link">All english songs</a></li>
...
<section id="lyrics">
 <div class="container" >
  ...
  <br><br><br>
	...
	<h2 style="color:white">All English Songs Lyrics</h2>
	</div>
	<br>
	<table>
			  <tr>
